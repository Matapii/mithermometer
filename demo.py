#!/usr/bin/env python3
"""Demo file showing how to use the mithermometer library."""
...
def valid_mithermometer_mac(mac, pat=re.compile(r"4C:65:A8:[0-9A-F]{2}:[0-9A-F]{2}:[0-9A-F]{2}")):
...
def scan(args):
    ...
    devices = mithermometer_scanner.scan(backend, 10)
...
def main():
    ...
    parser_poll.add_argument('mac', type=valid_mithermometer_mac)
